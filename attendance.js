...
const MODEL_URL = ' https://teachablemachine.withgoogle.com/models/dDeL419OM/';
...
async function predict() {
    ...
    const absentProb = prediction[1].probability;
    
    // Update status display
    if (presentProb > 0.8) {
        statusDiv.innerHTML = "<span class='present'>Rutu IS PRESENT</span>";  // Changed "Hani" to "Rutu"
